...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <style>{`html,body{max-width:100%;overflow-x:hidden}.nav{position:fixed;top:0;left:0;right:0;z-index:99999;width:100%;background:#f4f0e4;border-bottom:2px solid #120800;box-shadow:0 6px 18px rgba(0,0,0,.08);overflow:visible}.nav-inner{max-width:1400px;margin:0 auto;padding:16px 80px;display:flex;align-items:center;justify-content:space-between;gap:35px;position:relative}.brand{display:flex;align-items:center;gap:14px;text-decoration:none;color:#120800;min-width:0}.brand-logo{width:76px;height:76px;display:flex;align-items:center;justify-content:center;flex:0 0 76px;overflow:hidden;border-radius:50%}.brand-logo img{width:76px;height:76px;display:block;object-fit:cover;border-radius:50%}.brand-text{display:flex;flex-direction:column;justify-content:center;gap:5px;min-width:0}.brand-name{font-size:22px;line-height:1;font-weight:900;letter-spacing:.02em;white-space:nowrap;color:#120800}.brand-tag{display:block;color:#ff7a00!important;font-size:11px;font-weight:800;letter-spacing:.16em;text-transform:uppercase;white-space:nowrap}.primary-nav ul{display:flex;align-items:center;gap:42px;list-style:none;margin:0;padding:0}.primary-nav a{text-decoration:none;color:#120800;font-size:14px;font-weight:800;letter-spacing:.18em;text-transform:uppercase;transition:.25s}.primary-nav a:hover{color:#00a84f}.explore-wrap{position:relative;flex:0 0 auto;padding-bottom:18px;margin-bottom:-18px}.btn-pill{border:0;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;min-height:52px;padding:0 30px;background:#120800;color:#fff;text-decoration:none;font-size:13px;font-weight:900;letter-spacing:.18em;text-transform:uppercase;transition:.25s;box-shadow:6px 6px 0 #00c853}.btn-pill:hover{background:#00c853;color:#000}.explore-dropdown{position:absolute;right:0;top:100%;width:320px;background:#0b111d;border:1px solid rgba(97,255,75,.25);border-radius:10px;padding:12px;box-shadow:0 18px 45px rgba(0,0,0,.35);opacity:0;visibility:hidden;pointer-events:none;transform:translateY(8px);transition:opacity .18s ease,transform .18s ease,visibility .18s ease;z-index:100000}.explore-dropdown.show{opacity:1;visibility:visible;pointer-events:auto;transform:translateY(0)}.explore-dropdown::before{content:"";position:absolute;right:30px;top:-8px;width:16px;height:16px;background:#0b111d;border-left:1px solid rgba(97,255,75,.25);border-top:1px solid rgba(97,255,75,.25);transform:rotate(45deg)}.explore-dropdown a{display:flex;align-items:center;gap:14px;text-decoration:none;color:#fff;padding:14px 12px;border-radius:8px;transition:.22s}.explore-dropdown a:hover{background:rgba(97,255,75,.12);transform:translateX(4px)}.explore-dropdown a span{width:36px;height:36px;border-radius:50%;background:#050505;display:flex;align-items:center;justify-content:center;font-size:18px;border:1px solid rgba(97,255,75,.35);flex:0 0 auto}.explore-dropdown strong{display:block;color:#f5f0e6;font-size:15px;line-height:1.1}.explore-dropdown small{display:block;color:#9aa4b2;font-size:12px;margin-top:4px;line-height:1.35}@media(max-width:900px){.nav-inner{padding:12px 14px;gap:10px;align-items:center}.primary-nav{display:none}.brand{gap:9px;flex:1;min-width:0}.brand-logo{width:60px;height:60px;flex-basis:60px}.brand-logo img{width:60px;height:60px;object-fit:cover}.brand-text{min-width:0;max-width:190px}.brand-name{font-size:18px}.brand-tag{display:block!important;font-size:8px;letter-spacing:.05em;white-space:normal;line-height:1.25;max-width:190px;overflow:visible}.btn-pill{padding:0 12px;min-height:42px;font-size:9px;letter-spacing:.1em;box-shadow:4px 4px 0 #00c853}.explore-wrap{padding-bottom:0;margin-bottom:0}.explore-dropdown{position:fixed;right:12px;top:76px;width:min(310px,calc(100vw - 24px));max-height:calc(100vh - 90px);overflow-y:auto}.explore-dropdown::before{right:28px}}@media(max-width:430px){.nav-inner{padding:10px 10px}.brand-logo{width:54px;height:54px;flex-basis:54px}.brand-logo img{width:54px;height:54px}.brand-name{font-size:16px}.brand-tag{font-size:7.5px;max-width:165px}.btn-pill{font-size:8px;padding:0 9px;min-height:38px}.explore-dropdown{top:68px}}`}</style>
    </>
  );
}
